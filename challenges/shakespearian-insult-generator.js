...
let firstRandom = Math.floor(Math.random() * first_word.length); 
let secondRandom = Math.floor(Math.random() * second_word.length); 
let thirdRandom = Math.floor(Math.random() * third_word.length); 
