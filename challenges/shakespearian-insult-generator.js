...
var randomItemFirst = first_word[Math.floor(Math.random()*first_word.length)];

var randomItemSecond = second_word[Math.floor(Math.random()*second_word.length)];

var randomItemThird = third_word[Math.floor(Math.random()*third_word.length)];
